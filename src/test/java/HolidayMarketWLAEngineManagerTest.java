...
public class HolidayMarketWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HolidayMarketWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HolidayMarketWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HolidayMarketWLAIW/InitOutcome.xml").getDocumentElement();
